 ...
 * Date: 24.10.16
 * Time: 12:27
 * @var extensions\yii\bootstrap\FilterForm $form
 * @var                                     $filterModel
 * @var                                     $fields = array
 */
    ...
    <?php for ($rowIndex = 0; $rowIndex < $rows; $rowIndex++): ?>
        <div class="row">
            ...
            foreach ($thisRowFields as $attribute => $fieldConfig):?>
                <div class="col-sm-<?= $bootstrapColClass ?>">
                    <div class="form-group">
                        ...
                        if (isset($fieldConfig['type'])) {
                            ...
                            if ($fieldType == 'dropDownList') {
                                ...
                                echo call_user_func([$field, $fieldType], $items, $fieldConfig);
                            } else {
                                echo call_user_func([$field, $fieldType], $fieldConfig);
                            }
