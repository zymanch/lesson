...
namespace extensions\gii\templates\crud;
...
use yii\gii\Generator as YiiGiiGenerator;
...
class Generator extends YiiGiiGenerator
{
    ...
    public $indexWidgetType     = 'inspiniaGrid';
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            ...
            [['indexWidgetType'], 'in', 'range' => ['grid', 'list', 'inspiniaGrid']],
     ...
     * @return string
     */
    public function generateFilterColumn($column)
    {
        return '\'' . $column . '\'';
    }
