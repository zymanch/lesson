...
use yii\helpers\Html;use <?php switch ($generator->indexWidgetType) {
    case 'grid':
...
$this->title = <?= $generator->generateString(Inflector::pluralize(Inflector::camel2words(StringHelper::basename($generator->modelClass)))) ?>;$this->params['breadcrumbs'][] = $this->title;?>
        ...
        <div class="ibox">
            <div class="ibox-content">
                ...
                ?>
                             ...
                             return Html::a('Delete', ['delete', <?= $urlParams ?>], ['class' => 'btn-white btn
                             btn-xs']);
                             },
                             ]
                             ],
